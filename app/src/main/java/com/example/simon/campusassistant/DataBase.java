...
/**
 * Created by Simon on 12/16/2017.
 */
...
public class DataBase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        for(int i=0;i<7;i++){
            String sql="CREATE TABLE "+TB_NAME[i]+" (_id INTEGER primary key autoincrement,classes varchar(70),location varchar(70)," +
                    "teacher varchar(70),time1 varchar(70),time2 varchar(70))";
            db.execSQL(sql);
        }
    ...
    public  long insert(int i,String cla,String loca,String tea,String time1,String time2){
    ...
    public void update(int i,int _id,String cla,String loca,String tea,String time1,String time2){
        SQLiteDatabase db=DataBase.this.getWritableDatabase();
        String where="_id = ?";
